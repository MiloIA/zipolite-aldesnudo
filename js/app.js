...
function mostrarStep3(res, info) {
  ...
  let html = `<h3 style="color:#2e7d32;font-family:'Fraunces',serif;font-size:1.4rem;margin-bottom:6px;">✅ ¡Lugar apartado!</h3>
    ...
    <a href="pago.html?reservacion=${res.id}" style="display:block;background:#E8312A;color:#fff;padding:1rem;border-radius:8px;text-decoration:none;font-weight:700;font-size:1rem;text-align:center;margin-bottom:1rem;">💳 Completar pago →</a>
